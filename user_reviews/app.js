...
window.addEventListener('DOMContentLoaded', () => {
  ...
  userImage.src = currentUser.img;
  userName.textContent = currentUser.name;
  userOccupation.textContent = currentUser.job;
  userReview.firstChild.textContent = currentUser.text;
});
...
btns.forEach((btn) => {
  btn.addEventListener('click', (e) => {
    if (e.currentTarget.classList.contains('previous-btn')) {
      if (count === 0) {
